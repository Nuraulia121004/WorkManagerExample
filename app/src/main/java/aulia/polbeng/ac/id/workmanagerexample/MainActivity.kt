package aulia.polbeng.ac.id.workmanagerexample
...
import aulia.polbeng.ac.id.workmanagerexample.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private val maxCounter = workDataOf(MyWorker.COUNTER to 10)
        ...
        workManager.getWorkInfoByIdLiveData(id)
            .observe(this) { info ->
                ...
                if (info != null && info.state.isFinished) {
                    ...
                    // 3
                    val message =
                        info.outputData.getString(MyWorker.MESSAGE)
                    if (message != null) {
    ...
    private fun createPeriodicWorkRequest() {
        // 1
        val imageWorker = PeriodicWorkRequestBuilder<MyWorker>(
            2, TimeUnit.MINUTES)
            .setInputData(maxCounter)
            .setConstraints(constraints)
            .addTag("imageWork")
